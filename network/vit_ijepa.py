...
import sys
sys.path.append('/home/liucancheng/ijepa')
...
y_file = '/home/liucancheng/ijepa/configs/in1k_vith16-448_ep300.yaml'
r_path = '/data2/nerf_data/ijepa/checkpoint/IN1K-vit.h.16-448px-300e.pth.tar'
# device = 'cpu'
...
# mask_collator = multiblock.MaskCollator(    
...
def _make_pretrained_vitb16_128(
    ...
    model = target_encoder # timm.create_model("vit_base_patch16_224", img_size=128, pretrained=pretrained)
