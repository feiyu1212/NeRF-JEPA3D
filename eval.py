...
def gen_eval(args):
    ...
    for d_idx in data_index:
        ...
        if obj_name not in ['247dd48e4b6c029e4b3c42e318f3affc', '3e1a5042dcff313971a782a4379556c7', '6e1e73e14637a28da1c367d7a459a9b7', 'b6457a76f24de9f67aa6f8353fce2005', 'cc6d6035bb5074261f98c0761af40e04', '317a2cc9f3b54a48283b00891f680579', '44a2a3952ea2315ff51f77a6d7299806', 'aa80259311e2a8c0d8bd0a659ff7eef6', 'bffe3e68857faf7f4d1242a685303c47', 'e31d71ed32273fede42ac999db581f5e', '3b1b0186ebeb8ea579bb09dc5605a57', '6aaa9bd6e835eb0f9b9f2eb77f5e247e', 'b3a9c49a1924f99815f855bb1d7c4f07', 'c9d68e1e5309ac25ac57e7d566628472', 'fdac1f9c0b030841c8687ff9b0b4e4ac', '12941cb870df79b9815337ac44abb964', '3c6d7c6ce950917b3a93df79ef2b80ef', '6bbcd5608ddf871a4cdd04162f008888', 'add26d8f4f91ba04c84b95bddf75b22d', 'c0db588c8c816cd2dc668d3d64c871ae', 'dd35ef6632cf507804272696dc83193', 'f9fbc58e3692c4d5583d20ad0a6b981d', '18da5e80080352be294d52e32dbd135b', '42e6ce03b361102ab86e0633bb69faea', '817bb8c69e4ac23ec81ddeca50aa3117', 'b09f4d5af99be6c5f5f45e906b41d1f0', 'c3a1e04f49e80d22a10cf495b6dc4ef', '1cb95c00d3bf6a3a58dbdf2b5c6acfca', '65ccd33df41999496d6573f48a06281', 'acdb7b476fc5a1ca96f65931c8819eb', 'bbf84d45735af3314dde7b6e74a2cede', 'c57c11cbcb97f74058c27e607f6e2d4c', 'f18093ac0242d439f500cc506a763c18']:
            continue
        out_folder = os.path.join(args.outdir, args.expname, str(args.pose_index), obj_name) # f'{d_idx:06d}'
        ...
        with torch.no_grad():
            ...
            for idx, pose in tqdm.tqdm(zip(view_indices, render_poses), total=len(view_indices)):
                if idx not in [80, 96, 112, 128, 144, 160, 176]:
                    continue
